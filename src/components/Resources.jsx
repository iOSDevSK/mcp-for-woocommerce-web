...
function ResourcePattern({ mouseX, mouseY, ...gridProps }) {
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-linear-to-r from-[#e9d5ff] to-[#f3e8ff] opacity-0 transition duration-300 group-hover:opacity-100 dark:from-[#2e1065] dark:to-[#3730a3]"
        style={style}
      />
      <motion.div
