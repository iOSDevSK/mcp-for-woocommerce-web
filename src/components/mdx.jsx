...
export function wrapper({ children }) {
  return (
    <article className="flex h-full flex-col pt-8 pb-10">
...
export function Note({ children }) {
  return (
    <div className="my-6 flex gap-2.5 rounded-2xl border border-purple-500/20 bg-purple-50/50 p-4 text-sm/6 text-purple-900 dark:border-purple-500/30 dark:bg-purple-500/5 dark:text-purple-200 dark:[--tw-prose-links-hover:var(--color-purple-300)] dark:[--tw-prose-links:var(--color-white)]">
